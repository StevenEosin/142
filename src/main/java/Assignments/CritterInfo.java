package Assignments;// The Assignments.CritterInfo interface defines a set of methods for querying the
// state of a critter simulation.  You should not alter this file.  See
// the documentation in the Assignments.Critter class for a more detailed explanation.
